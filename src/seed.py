    ...
    try :
        ...
        transfer = [
            ...
            Transfer(id=str(uuid4()), account_id="1468152645150", tran_date="2025-01-10", tran_time="09:30",
                     ...
                     branch_name=""),
            Transfer(id=str(uuid4()), account_id="1468152645150", tran_date="2025-01-10", tran_time="12:35",
                     inout_type="출금", tran_type="결재", print_content="동화가든", tran_amt="84000", after_balance_amt="3128700",
                     branch_name=""),
            Transfer(id=str(uuid4()), account_id="1468152645150", tran_date="2025-01-10", tran_time="14:08",
                     inout_type="출금", tran_type="결재", print_content="카페 툇마루", tran_amt="42000", after_balance_amt="3086700",
                     branch_name=""),
            Transfer(id=str(uuid4()), account_id="1468152645150", tran_date="2025-01-10", tran_time="19:27",
                     inout_type="출금", tran_type="결재", print_content="강릉다물선횟집", tran_amt="165000", after_balance_amt="2921700",
                     branch_name=""),
            Transfer(id=str(uuid4()), account_id="1468152645150", tran_date="2025-01-10", tran_time="21:15",
                     inout_type="출금", tran_type="결재", print_content="CU경포비치점", tran_amt="25750", after_balance_amt="2895950",
                     branch_name=""),
            Transfer(id=str(uuid4()), account_id="1468152645150", tran_date="2025-01-11", tran_time="09:48",
                     inout_type="출금", tran_type="결재", print_content="교동짬뽕 강릉본점", tran_amt="64000", after_balance_amt="2831950",
                     branch_name=""),
            Transfer(id=str(uuid4()), account_id="1468152645150", tran_date="2025-01-11", tran_time="10:25",
                     inout_type="출금", tran_type="결재", print_content="오죽헌입장료", tran_amt="18000", after_balance_amt="2813950",
                     branch_name=""),
            Transfer(id=str(uuid4()), account_id="1468152645150", tran_date="2025-01-11", tran_time="14:08",
                     inout_type="출금", tran_type="결재", print_content="카페 뤼미에르", tran_amt="21000", after_balance_amt="2792950",
                     branch_name=""),
            Transfer(id=str(uuid4()), account_id="1468152645150", tran_date="2025-01-11", tran_time="16:04",
                     inout_type="출금", tran_type="결재", print_content="강릉수제어묵고로케", tran_amt="45000", after_balance_amt="2747950",
                     branch_name=""),
            Transfer(id=str(uuid4()), account_id="1468152645150", tran_date="2025-01-11", tran_time="19:58",
                     inout_type="출금", tran_type="결재", print_content="금학칼국수", tran_amt="58000", after_balance_amt="2689950",
                     branch_name=""),
            Transfer(id=str(uuid4()), account_id="1468152645150", tran_date="2025-01-11", tran_time="20:30",
                     inout_type="출금", tran_type="결재", print_content="홈플러스 강릉점", tran_amt="37520", after_balance_amt="2652430",
                     branch_name=""),
            Transfer(id=str(uuid4()), account_id="1468152645150", tran_date="2025-01-12", tran_time="08:17",
            ...
            Transfer(id=str(uuid4()), account_id="1468152645150", tran_date="2025-01-15", tran_time="10:17",
                     inout_type="출금", tran_type="결재", print_content="자연도소금빵", tran_amt="12000", after_balance_amt="2628430",
                     branch_name=""),
            Transfer(id=str(uuid4()), account_id="1468152645150", tran_date="2025-01-15", tran_time="13:10",
                     inout_type="출금", tran_type="결재", print_content="소문난성수감자탕", tran_amt="57000", after_balance_amt="2571430",
                     branch_name=""),
            Transfer(id=str(uuid4()), account_id="1468152645150", tran_date="2025-01-15", tran_time="14:17",
                     inout_type="출금", tran_type="결재", print_content="무신사스탠다드성수점", tran_amt="99000", after_balance_amt="2472430",
                     branch_name=""),
            Transfer(id=str(uuid4()), account_id="1468152645150", tran_date="2025-01-15", tran_time="14:48",
